...
#+begin_src lua
  ...
  function build()
     ...
     local myawesomemenu = { 
        ...
        { "&Edit config", editor .. " " .. awful.util.getdir("config") .. "/rc.lua", freedesktop_utils.lookup_icon({ icon = 'wallpaper' }) },
...
#+begin_src lua
  ...
  awful.key({modkey, "Shift"   }, "a", -- nopopup new tag function() shifty.add({nopopup = true}) end),
